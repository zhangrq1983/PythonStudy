a = dict(name='孙悟空', age=18, gender='男')
print('a = ', a, type(a), id(a))
print()

b = dict([('name', 'sunwufan'), ('age', 18)])
...
result = a.setdefault('name', 'zhubajie')
print(a)
print(result)

result = a.setdefault('hello', 'hello')
print(a)
print(result)
